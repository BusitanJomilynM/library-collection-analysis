...
<div class="two-col">
    ...
    <div class="form-group">
        <label>Volume</label>
        <input class="form-control @error('book_volume') is-invalid @enderror" type="text" name="book_volume" id="book_volume" value="{{$book->book_volume}}" minlength="2" maxlength="40" hidden>
        @error('book_volume')
            <span class="text-danger">{{$message}}</span>
        @enderror
    </div>
...
<div class="two-col">
    <div class="col1">
        <label>Copyright Year</label>
            <select class="form-control @error('type') is-invalid @enderror" type="number" name="book_copyrightyear" id="book_copyrightyear" value="{{ old('book_copyrightyear') }}" hidden>
    ...
    <div class="form-group">
        ...
        <input class="form-control @error('book_subject') is-invalid @enderror" type="text" name="book_subject" id="book_subject" value="{{$tag->suggest_book_subject}}" minlength="4" maxlength="50" readonly>
        @error('book_subject')
            <span class="text-danger">{{$message}}</span>
        @enderror
    </div>
...
<div class="col2">
        <label>Status</label>
        <input class="form-control" type="text" name="status" id="status" value="1">
        @error('book_isbn')
            <span class="text-danger">{{$message}}</span>
        @enderror
    </div>
